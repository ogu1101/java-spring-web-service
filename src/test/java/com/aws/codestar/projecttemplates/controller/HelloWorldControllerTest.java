...
/**
 * Tests for {@link HelloWorldController}. Modify the tests in order to support your use case as you
 * build your project.
 */
...
public class HelloWorldControllerTest {
  ...
  void testGetRequest() {
    ResponseEntity<String> responseEntity = controller.helloWorldGet(INPUT_NAME);

    // Verify the response obtained matches the values we expect.
    JSONObject jsonObjectFromResponse = new JSONObject(responseEntity.getBody().toString());
    Assertions.assertEquals(EXPECTED_RESPONSE_VALUE, jsonObjectFromResponse.get("Output"));
  ...
  void testPostRequest() {
    ResponseEntity<String> responseEntity = controller.helloWorldPost(INPUT_NAME);
